  ...
  import { resetForm, updateField } from "../redux/patient/patientFormSlice";
  ...
  export default function ProfileForm() {
    ...
    const handleSubmit = (values, { setSubmitting }) => {
      ...
      //setActiveStep(0); // push the form into the 0 step if user is submited the form.
      dispatch(resetForm());
      persistor.purge();
      setSubmitting(true);
    };
                ...
                <Box elevation={0}>
                  ...
                  {activeStep === 0 && (
                    <>
                      ...
                      <CustomToggles values={values} 
                        fields={["isMarried","hasDiabetes","hasHypertension"]} 
                      />
                    </>
                  )}
                    ...
                    <>
                      ...
                      <Box sx={{ display: 'flex', gap: 2, mb: 3 }}>
                        ...
                        <Box sx={{ flex: 1 }}>
                          <TextField
                            ...
                            // onChange={handleChange}
                            onChange={(e) =>
                                handleZipChange(e, setFieldError, setFieldTouched, setFieldValue)
                              }
                            // onBlur={handleBlur}
                      ...
                      <Box sx={{ mb: 3 }}>
                        <TextField
                          ...
                          // onChange={handleChange}
                          onChange={(e)=>{
                            dispatch(updateField({field:"address1", value: e.target.value }));
                    ...
                    <StepHeader src="/age.svg" title="Age" />
                      <AgeSection 
                        ...
                        onBirthdateChange={(e) => {
                          ...
                          updateRedux("birthdate", birthdate);
                          // setFieldValue('age', calculatedAge);
                          updateRedux("age", calculatedAge);
                        }}
                        // onAgeChange={(e) => setFieldValue('age', e.target.value)}
                        onAgeChange={(e)=> updateRedux("age", e.target.value)}
                        errors={errors}
                        touched={touched}
                  ...
                  {activeStep === 4 && (
                    ...
                    <StepHeader src="/weight.svg" title=" Weight" />
                      <WeightSelector 
                        ...
                        onWeightChange={(e,newValue) => updateRedux("weight", newValue )}
                        error={errors.weight}
                        ...
                        onUnitChange={(unit) => {
                          ...
                          updateRedux("weightUnit", unit);
                          // setFieldValue('weight', convertedWeight);
                        updateRedux("weight", convertedWeight);
                      }}
                      />
                    </>
                  )}
                  ...
                  {activeStep === 5 && (
                    ...
                    <StepHeader src="/height.svg" title=" Height" />
                      <HeightSelector 
                        ...
                        onHeightChange={(e,newValue)=> updateRedux("height", newValue)}
                        onUnitChange={(unit) => {
                          ...
                          updateRedux("heightUnit", unit);
                          // setFieldValue('height', convertedHeight);
                          updateRedux("height", convertedHeight);
                        }}
                      />
                    </>
                  )}
                    ...
                    <>
                      ...
                      <FormControl fullWidth error={touched.bloodGroup && Boolean(errors.bloodGroup)}>
                        <RadioGroup 
                          ...
                          // onChange={handleChange}
                          onChange={(e)=> {
                            dispatch(updateField({field:"bloodGroup", value: e.target.value}));
                          }}
                          onBlur={handleBlur}
                        >
